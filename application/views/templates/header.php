	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			...
			<header class="main-header">
				...
				<span class="logo-mini"><img src="<?php echo base_url(); ?>assets/images/logos/ci-white.png" title="" style="position: relative; top: -3px; height: 16px;"> <b>alt</b></span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><img src="<?php echo base_url(); ?>assets/images/logos/ci-white.png" title="" style="position: relative; top: -3px; height: 26px; margin-right: 5px;"><b>Admin</b>LTE</span>
				</a>
				...
				<nav class="navbar navbar-static-top">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs"><?php echo $page['user']; ?></span>
						</a>
						<ul class="dropdown-menu">
							<!-- User image -->
